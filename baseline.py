...
if __name__ == '__main__':
	...
	parser.add_argument('--testDomain', type=str, default="finance")
	...
	wandb.init(project="domain-adaptation-trial", config=args)
	...
	train_dataloader, val_dataloader, test_dataloader = create_dataset_loader(train_text, train_labels, val_text, val_labels, test_text, test_labels, trainSequenceLength, testSequenceLength, batch_size)
	...
	optimizer = AdamW(model.parameters(), lr = 1e-5)  # optimizer and learning rate
